...
- **In-game MDT** - Added a LemonUI police computer for quick PED lookups, vehicle lookups, Recent IDs, nearby vehicles, and citations.

### MDT Cloud Preparation

- **MDT Cloud platform** - Added the prerequisite platform services and in-game LemonUI settings required for the upcoming Cloud sign-in flow.
- **MDT Cloud portal** - Shift timers now start and stop automatically as part of the Cloud portal workflow.
