...
namespace MDTPro.Setup {
    internal class Config {
        ...
        /// <summary>Minimum seconds before the same plate can trigger another web ALPR toast from the built-in scanner. Clamped 15–600 in code; 0 or invalid reads as 90.</summary>
